...
Imported from `csthink/dashmotion` at commit `ae2fe4f28c60caa53da8b15fa3537f4ea576f4ad` under the MIT license.

Use this skill when the user needs an actual animated HTML/SVG technical diagram, such as an architecture walkthrough, workflow demo, or Mermaid-to-animated-diagram conversion. Do not use it for ordinary prose explanations or when a short static diagram is sufficient.

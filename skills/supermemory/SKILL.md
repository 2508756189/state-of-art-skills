---
name: supermemory
description: Capture, retrieve, and reconcile durable project memory without leaking secrets. Use when the user wants important decisions, workflows, links, facts, or repeated troubleshooting lessons saved or searched through a Supermemory-like service or a local memory store.
---
